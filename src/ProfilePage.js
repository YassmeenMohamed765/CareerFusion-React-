      ...
      <div className="profile-info">
        ...
        {profile.Projects.map((project, index) => (
            <div className="section-content" key={index}>
              ...
              <label htmlFor={`projectName-${index}`}>Project Name{index + 1}:</label>
              ...
              <label htmlFor={`projectUrl-${index}`}>Project URL {index + 1}:</label>
              <input
                type="text"
                id={`projectUrl-${index}`}
                value={project.url}
          ...
          {profile.Courses.map((course, index) => (
            <div className="section-content" key={index}>
              <label htmlFor={`courseName-${index}`}>Course Name {index + 1}:</label>
              <div className="input-icon-container">
              <input
                type="text"
                id={`courseName-${index}`}
          ...
          {profile.Skills.map((skill, index) => (
            <div className="section-content" key={index}>
              <label htmlFor={`skillName-${index}`}>Skill Name {index + 1}:</label>
              <div className="input-icon-container">
              <input
                type="text"
                id={`skillName-${index}`}
              ...
              <label htmlFor={`skillLevel-${index}`}>Skill Level {index + 1}:</label>
              <input
                type="text"
                id={`skillLevel-${index}`}
          ...
          {profile.SiteLinks.map((link, index) => (
            <div className="section-content" key={index}>
              <label htmlFor={`linkUrl-${index}`}>Link URL {index + 1}:</label>
              <div className="input-icon-container">
              <input
                type="text"
                id={`linkUrl-${index}`}
